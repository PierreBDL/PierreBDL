...
N'hésite pas à jeter un œil à mes dépôts épinglés juste en dessous ! Tu y trouveras notamment :
* 🎮 Des projets de jeux en **C# / Unity**, **GDScript / Godot** et en **Go** (comme mon projet *My Spell Academia*).
* 🕸️ Des applications et sites web dynamiques mêlant **JS, Canvas, PHP et JSON**.
